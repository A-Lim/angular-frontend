...
import { FormCustomerEditTransactionComponentStore } from './form-customer-edit-transaction.component-store';

@Component({
  selector: 'app-form-customer-edit-transaction',
  standalone: true,
  imports: [
    AsyncPipe,
    NgIf,
  ...
  templateUrl: './form-customer-edit-transaction.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [FormCustomerEditTransactionComponentStore],
})
export class FormCustomerEditTransactionComponent implements OnInit {
  private _componentStore = inject(FormCustomerEditTransactionComponentStore);
